...
public class NewMasterDetailForm extends JPanel {
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("LOCALHOST\\\\SQLEXPRESS:1433;databaseName=Demo_ISO815PU").createEntityManager();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<iso815_2.Productos> toRemove = new ArrayList<iso815_2.Productos>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            iso815_2.Productos p = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(p);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        iso815_2.Productos p = new iso815_2.Productos();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<iso815_2.Productos> merged = new ArrayList<iso815_2.Productos>(list.size());
            for (iso815_2.Productos p : list) {
    ...
    private java.util.List<iso815_2.Productos> list;
